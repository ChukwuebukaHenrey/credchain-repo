# ─────────────────────────────────────────────────────────────
# CredChain — CV Studio page (Week 1, CV Studio contribution)
# A polished single-page UI (form + live preview) for the demo.
# Served by the AI CV Engine at GET /studio; it calls the engine's
# own POST /generate-cv/image endpoint to render the designed CV.
#
# Palette matches the shared CredChain brand (navy + blue).
# ─────────────────────────────────────────────────────────────
