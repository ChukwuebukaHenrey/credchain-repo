# ─────────────────────────────────────────────────────────────
# CredChain — CV image renderer (Week 1, CV Studio contribution)
# Turns a CV data dict into a designed PNG using Pillow.
# Pure rendering only — no FastAPI / web concerns live here.
#
# This is the original CV Studio renderer, integrated into the AI CV
# Engine so the image endpoint (/generate-cv/image) and the Studio UI
# (/studio) run as part of the same service alongside the PDF builder.
# Its navy + blue palette is now the shared CredChain brand scheme.
# ─────────────────────────────────────────────────────────────
...
# ── Palette (CredChain brand: navy + blue) ───────────────────
